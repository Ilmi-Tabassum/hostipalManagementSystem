                ...
                <div class="card">
                    ...
                    <div class="card-body chat-box scrollable" style="height:300px;">
                        <ul class="chat-list">
                            ...
                            <li class="chat-item">
                                <div class="chat-img"><img src="{{asset('template/users/3.jpg')}}" alt="user"></div>
                                <div class="chat-content">
            ...
            <div class="card-body">
                <table id="advanced_table" class="table">
                    ...
                    <tr>
                        ...
                        <td><img src="{{asset('template//users/4.jpg')}}" class="table-user-thumb" alt=""></td>
                        <td>Cedric Kelly</td>
        ...
        <div class="chat-list">
            <div class="list-group row">
                ...
                <a href="javascript:void(0)" class="list-group-item" data-chat-user="Shelly Sullivan">
                    <figure class="user--offline">
                        <img src="{{asset('template//users/2.jpg')}}" class="rounded-circle" alt="">
