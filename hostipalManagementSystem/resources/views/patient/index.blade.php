    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="modal fade" id="AddPatientModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                     aria-hidden="true">
                ...
                <div class="modal fade" id="EditPatientModal" tabindex="-1" aria-labelledby="EditPatientModal"
                     aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <h4> Patients Data
                                        <a href="#" data-bs-toggle="modal" data-bs-target="#AddPatientModal"
                                           class="btn btn-primary float-end btn-sm">Add Patient</a>
                                    </h4>
                                </div>
                                <div class="card-body">
                            ...
                            $(document).on('click', '.add_patient', function (e) {
                                ...
                                $.ajax({
                                    ...
                                    success: function (response) {
                                        ...
                                        // dont understand why you have used 400 status code because
                                        // api did get only success or failure code
                                        if (response.status == 400) {
